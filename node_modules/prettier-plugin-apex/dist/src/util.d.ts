...
export declare type SerializedAst = {
    [APEX_TYPES.PARSER_OUTPUT]: jorje.ParserOutput;
};
export declare type GenericComment = jorje.HiddenToken;
declare type AstNode = {
    "@class": string;
    "@id": string;
};
declare type ReferenceNode = {
    "@reference": string;
};
export declare type Node = AstNode | ReferenceNode;
export declare type AnnotatedAstNode = AstNode & {
    trailingEmptyLine?: boolean;
    isNextStatementOnSameLine?: boolean;
    isLastNodeInArray?: boolean;
};
export declare type AnnotatedComment = AnnotatedAstNode & GenericComment & {
    trailing?: boolean;
    leading?: boolean;
    printed?: boolean;
    enclosingNode?: any;
